...
const ShowDetailsPage = (props) => {
  ...
  const getShowSummary = async () => {
    const summaryResp = await axios.get(
      `http://api.themoviedb.org/3/tv/${showID}?api_key=e39bd4d7934850f869dcfd33c094d2bc&language=en-US&page=1`
    )
        ...
        <div className="outer">
          <div className="detail-box">
            <div className="left-box">
              <img
                src={`https://image.tmdb.org/t/p/w185_and_h278_bestv2${summary.poster_path}`}
                alt="Movie Poster"
              />
            </div>
